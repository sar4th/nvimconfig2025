...
vim.keymap.set("n", "<leader>bb", "<C-^>", { desc = "Toggle previous buffer" })
...
-- Reverse j and k in Visual mode
...
vim.api.nvim_create_autocmd("BufLeave", {
  pattern = "*",
  command = "if &buftype == 'nofile' | q! | endif"
})
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          if client and client:supports_method(vim.lsp.protocol.Methods.textDocument_documentHighlight) and vim.bo[event.buf].filetype ~= 'yaml' then
